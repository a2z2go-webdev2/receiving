...
class WarehouseAccessOtpCode extends Notification implements ShouldBeEncrypted, ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('[Receiving Operations] Warehouse verification code')
            ->greeting('Verify your warehouse access')
